        ...
        <div class="container">
          ...
          <table>
            ...
            <tr class="total-row">
              ...
              <td>${empDetails.monthlyCTC || "0.00"}</td>
              <td></td>
              <td>Total Deductions</td>
              <td>${empDetails.totalDeduction || "0.00"}</td>
              <td></td>
            </tr>
          </table>
          
          <div class="net-pay-section">
            <div class="net-pay">Total Net Pay ${empDetails.netpay || "₹0.00"} (${empDetails.netpayInWords || "Zero Only"})</div>
            ...
            {dataLoading ? (
                ...
                <ScrollView style={styles.payslipDetailContainer}>
                    <View style={styles.payslipCard}>
                        ...
                        {/* Title */}
                        <Text style={styles.payslipTitle}>Payslip for the month of {empDetails.payMonth || "May 2025"}</Text>
                        ...
                        <View style={styles.tableSection}>
                            ...
                            <View style={[styles.tableRow, styles.totalRow]}>
                                ...
                                <Text style={styles.tableCellTotal}>{empDetails.monthlyCTC}</Text>
                                <Text style={styles.tableCellTotal}></Text>
                                {/* <Text style={styles.tableCellTotal}>{totalYtdEarnings.toFixed(1)}</Text> */}
                            </View>
                        </View>
                        ...
                        <View style={styles.netPaySection}>
                            ...
                            <Text style={styles.netPayNote}>**Total Net Payable = Gross Earnings - Total Deductions</Text>
                        </View>
